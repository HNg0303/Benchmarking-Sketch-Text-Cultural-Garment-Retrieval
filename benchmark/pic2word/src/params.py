...
def parse_args():
    ...
    parser.add_argument("--eval-mode",
        type=str,
        choices=["coco", "cirr", "cirr_test", "fashion", "imgnet", "aodai"],
        default="aodai",
        help="Evaluate Pacs")
    ...
    parser.add_argument(
        "--dataset-type",
        choices=["webdataset", "csv", "inet", "auto", "inet,csv", "csv,inet", "directory", "fashion-iq", "cirr", "imgnet_r", "aodai"],
        default="auto",
    ...
    parser.add_argument('--distributed', action='store_true', help='Use distributed training/eval')
